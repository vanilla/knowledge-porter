 ...
 */
class TestDestination extends AbstractDestination {
    ...
    public function importKnowledgeBases(iterable $rows): iterable {
        foreach ($rows as $row) {
            ...
            yield [
                ...
                'sortArticles' => 'manual',
                'insertUserID' => 2,
                'dateInserted' => '2020-09-29T13:32:45+00:00',
                'updateUserID' => 2,
                'dateUpdated' => '2020-09-29T13:34:47+00:00',
                'countArticles' => 1,
                'countCategories' => 1,
                'urlCode' => 'docs',
                'url' => 'http://dev.vanilla.localhost/kb/docs',
                'icon' => '',
                'bannerImage' => '',
                'bannerContentImage' => '',
                'sourceLocale' => 'en',
